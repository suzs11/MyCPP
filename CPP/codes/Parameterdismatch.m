...
figure(1);
plot(outdata(trainLen+3:trainLen+2+number,1),outdata(trainLen+3:trainLen+2+number,3));
...
figure(4);
% plot(outdata(trainLen+3:trainLen+2+71,1),outdata(trainLen+3:trainLen+2+71,3),'--');
% hold on
plot(outdata(trainLen+74:trainLen+2+number,1),outdata(trainLen+74:trainLen+2+number,3),'. ');
xlabel('\it{x}','FontName','Times New Roman','FontSize',26);
ylabel('\it{z}','FontName','Times New Roman','FontSize',26);

figure(5)
% plot(Pdata(1:71,1),Pdata(1:71,3),'--');
% hold on
plot(Pdata(72:end,1),Pdata(72:end,3),'. ');
xlabel('\it{x}','FontName','Times New Roman','FontSize',26);
ylabel('\it{z}','FontName','Times New Roman','FontSize',26);
